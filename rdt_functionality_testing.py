...
print("Checksum verification of original message: {}".format(verifyUDPChecksum(unicodeMessage, checksum)))
print("Checksum verification of corrupted message: {}".format(verifyUDPChecksum(corruptedBits, checksum)))
